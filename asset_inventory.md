...
This document lists network connected assets identified within a small home network environment.  
Each asset includes basic access details and brief notes related to potential security considerations.
...
|------|---------------|-------|----------|-------------|----------------|
| Network Router | Continuous | ISP / Home Admin | Central | Confidential | Controls all network traffic and connects multiple device types; access is limited to the administrator |
